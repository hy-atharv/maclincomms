...
Each user is issued a unique **Identity Key Pair** at the time of registration. This key pair is an **X25519 key pair** (32 bytes each for public and private key) generated by the **Curve25519** algorithm using the [`x25519-dalek`](https://github.com/dalek-cryptography/curve25519-dalek/tree/main/x25519-dalek) crate, and stored securely on the device.
